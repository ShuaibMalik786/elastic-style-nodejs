...
let JumboController = class JumboController {
    constructor(service) {
...
], JumboController.prototype, "getAll", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], JumboController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], JumboController.prototype, "create", null);
__decorate([
    common_1.Put(':id'),
    ...
    __metadata("design:returntype", Promise)
], JumboController.prototype, "update", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], JumboController.prototype, "delete", null);
JumboController = __decorate([
    common_1.Controller('api/jumbotron'),
    __metadata("design:paramtypes", [jumbotron_service_1.JumbotronService])
], JumboController);
exports.JumboController = JumboController;
//# sourceMappingURL=jumbotron.controller.js.map