...
const modal_service_1 = require("../service/modal.service");
let ModalController = class ModalController {
    constructor(service) {
...
], ModalController.prototype, "getAll", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], ModalController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ModalController.prototype, "create", null);
__decorate([
    common_1.Put(':id'),
    ...
    __metadata("design:returntype", Promise)
], ModalController.prototype, "update", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ModalController.prototype, "delete", null);
ModalController = __decorate([
    common_1.Controller('api/modal'),
