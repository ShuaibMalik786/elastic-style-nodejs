...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PaginationController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PaginationController.prototype, "create", null);
__decorate([
    common_1.Put(':id'),
    ...
    __metadata("design:returntype", Promise)
], PaginationController.prototype, "update", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PaginationController.prototype, "delete", null);
PaginationController = __decorate([
    common_1.Controller('api/pagination'),
