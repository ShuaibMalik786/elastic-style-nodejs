...
let PillsController = class PillsController {
    constructor(service) {
...
], PillsController.prototype, "getAll", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], PillsController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PillsController.prototype, "create", null);
__decorate([
    common_1.Put(':id'),
    ...
    __metadata("design:returntype", Promise)
], PillsController.prototype, "update", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PillsController.prototype, "delete", null);
PillsController = __decorate([
    common_1.Controller('api/pills'),
    __metadata("design:paramtypes", [pills_service_1.PillsService])
], PillsController);
exports.PillsController = PillsController;
//# sourceMappingURL=pills.controller.js.map