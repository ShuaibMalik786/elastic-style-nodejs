...
let PopoverController = class PopoverController {
    constructor(service) {
...
], PopoverController.prototype, "getAll", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], PopoverController.prototype, "getOne", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PopoverController.prototype, "create", null);
__decorate([
    common_1.Put(':id'),
    ...
    __metadata("design:returntype", Promise)
], PopoverController.prototype, "update", null);
__decorate([
    common_1.Delete(':id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PopoverController.prototype, "delete", null);
PopoverController = __decorate([
    common_1.Controller('api/popover'),
    __metadata("design:paramtypes", [popover_service_1.PopoverService])
], PopoverController);
